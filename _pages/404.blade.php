...
<body class="bg-white dark:bg-dark-normal text-slate-800 dark:text-white antialiased">
    <div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl w-full text-center">
            ...
            <!-- 404 Text -->
            <h1 class="text-8xl md:text-9xl font-heading font-bold text-slate-900 dark:text-white mb-4">
                404
            </h1>
            ...
            <!-- Message -->
            <h2 class="text-3xl md:text-4xl font-heading font-bold text-slate-900 dark:text-white mb-4">
                Page Not Found
            </h2>
            ...
            <div class="mt-12 pt-8 border-t border-slate-200 dark:border-slate-700">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    ...
                    @endphp
                    @foreach ($navigation->items->take(3) as $item)
