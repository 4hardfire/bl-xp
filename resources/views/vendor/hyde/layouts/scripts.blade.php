{{-- Critical inline script for immediate interactivity --}}
<script>
...
{{-- The compiled Laravel Mix scripts - load first as it's smaller --}}
@if(Asset::hasMediaFile('app.js'))
    <script defer src="{{ Asset::mediaLink('app.js') }}"></script>
@endif

{{-- Alpine.js - Deferred loading for non-blocking performance --}}
