...
<header class="relative">
    <div class="absolute left-1/2 transform -translate-x-1/2 w-full p-6 z-10">
        <nav aria-label="Main navigation" id="main-navigation" class="container flex flex-wrap mx-auto rounded-xl p-4 items-center justify-between shadow-lg sm:shadow-xl bg-gray-200 md:shadow-none dark:bg-gray-light-solid">
            ...
            <div id="main-navigation-links" class="w-full x-uncloak-md md:flex flex-grow md:flex-grow-0 md:items-center md:w-auto border-t mt-3 pt-3 md:border-none md:mt-0 md:py-0 border-gray-200 dark:border-gray-700"
